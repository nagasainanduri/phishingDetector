...
class TestPolicyEngine(unittest.TestCase):
    ...
    def test_allow(self):
        ...
        detection = DetectionResult(raw_url="http://good.com", canonical_url="http://good.com", model_probability=0.1, ml_model_name="test", is_calibrated_probability=False, heuristic_findings=[])
    ...
    def test_warn_on_ml_only(self):
        ...
        detection = DetectionResult(raw_url="http://bad-ml-only.com", canonical_url="http://bad-ml-only.com", model_probability=0.99, ml_model_name="test", is_calibrated_probability=False, heuristic_findings=[])
    ...
    def test_block_with_heuristics(self):
        ...
        detection = DetectionResult(raw_url="http://bad.com", canonical_url="http://bad.com", model_probability=0.95, ml_model_name="test", is_calibrated_probability=False, heuristic_findings=[match])
    ...
    def test_critical_severity_hard_block(self):
        ...
        detection = DetectionResult(raw_url="http://threat.com", canonical_url="http://threat.com", model_probability=0.5, ml_model_name="test", is_calibrated_probability=False, heuristic_findings=[])
    ...
    def test_warn_threshold(self):
        ...
        detection = DetectionResult(raw_url="http://sus.com", canonical_url="http://sus.com", model_probability=0.75, ml_model_name="test", is_calibrated_probability=False, heuristic_findings=[])
